...
public class AdminCategoryController {
    ...
    public int countTotalCategories() throws InvalidFieldException {
        return categoryService.countTotalCatetories();
    }

    @GetMapping("/categories")
    public ResponseEntity getAllCategories(@Valid @RequestParam int pageNumber) throws InvalidFieldException {
        return new ResponseEntity<>(
                categoryService.getAllCategories(pageNumber),
                HttpStatus.OK);
    }
