...
public class AdminController {
    ...
    public List<CategoryDTO> getAllCategoriesByName(@Valid @RequestParam int pageNumber, @RequestParam String name){
        return categoryService.getAllCategoriesByName(pageNumber,name);
    }
    ...
    @DeleteMapping("/categories/sql/{id}")
    public ResponseEntity deleteSqlCategory(@PathVariable int id){
        try{
            return new ResponseEntity<>(
                    categoryService.deleteSqlCategory(id),
                    HttpStatus.OK);
        }
        catch (Exception e){
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
