...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    private SimpleJdbcCall simpleJdbcCallGetAllByCategoryId;
    private SimpleJdbcCall simpleJdbcCallGetAllByWarehouseId;
    ...
    public void setDataSource(DataSource dataSource) {
        ...
        this.simpleJdbcCallGetAllByCategoryId = new SimpleJdbcCall(dataSource).withProcedureName("get_products_by_category_id")
                .useInParameterNames("category_id1")
                .returningResultSet("products", productMapper);
        this.simpleJdbcCallGetAllByWarehouseId = new SimpleJdbcCall(dataSource).withProcedureName("get_products_by_warehouse_id")
                .useInParameterNames("warehouse_id1")
                .returningResultSet("products", productMapper);
    }
    ...
    public Product getProductById(int id) throws InvalidFieldException {
        ...
        if (!products.isEmpty()) {
            ...
            throw new InvalidFieldException("Not found product with id= "+id);
        }
    }
    ...
    public Product insertProduct(Product product) throws InvalidFieldException {
        ...
        if (productCode == null) {
            ...
            if (checkCode(productCode, 0)) {
                throw new InvalidFieldException("Product code already exists");
            }
        }
        SqlParameterSource sqlParameterSource = new MapSqlParameterSource()
        ...
        try {
            ...
            throw new InvalidFieldException("Category id or warehouse id not exists");
        }
    }
    ...
    public List<Product> getAllProductsByCategoryId(int categoryId) {
        SqlParameterSource sqlParameterSource = new MapSqlParameterSource()
                .addValue("category_id1", categoryId);
        Map<String, Object> objectMap = simpleJdbcCallGetAllByCategoryId.execute(sqlParameterSource);
    ...
    public List<Product> getAllProductsByWarehouseId(int warehouseId) {
        SqlParameterSource sqlParameterSource = new MapSqlParameterSource()
                .addValue("warehouse_id1", warehouseId);
        Map<String, Object> objectMap = simpleJdbcCallGetAllByWarehouseId.execute(sqlParameterSource);
    ...
    private Product updateProduct2(Product product) throws InvalidFieldException {
