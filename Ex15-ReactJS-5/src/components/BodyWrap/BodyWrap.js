            ...
            <div className="col-lg-9 col-md-9 col-sm-9">
                <ul className="nav menu2-right">
                    <li className="nav-item">
                        <div className="nav-link active-category-item" to="/categorys/may-tre-dan">Mây tre đan</div>
                    </li>
                    <li className="nav-item">
                        <div className="nav-link" to="/categorys/may-la-tre">Mây lá tre</div>
                    </li>
                    <li className="nav-item">
                        <div className="nav-link" to="/category/san-pham-may-la-tre">Sản phẩm mây tre lá</div>
                    </li>
                    <li className="nav-item">
                        <NavLink className="nav-link" to="/">Mỹ nghệ</NavLink>
                    </li>
                    <li className="nav-item">
                ...
                <div className="row content-left">
                    <div className="col-lg-3 col-md-3 col-sm-3 item-card">
                        <div className="mt-2">
                            ...
                            <div>
                                <img className="nav-link image" src="./image/Products/11.jpg" alt='' />
                            </div>
                            <div className="des">
                                <div>
                                    BLACK CREPE FLORAL PRINT
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-3 item-card">
                        <div className="mt-2">
                            ...
                            <div>
                                <img className="nav-link image" src="./image/Products/12.jpg" alt='' />
                            </div>
                            <div className="des">
                                <div>
                                    BLACK CREPE FLORAL PRINT
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-3 item-card">
                        <div className="mt-2">
                            ...
                            <div>
                                <img className="nav-link image" src="./image/Products/13.jpg" alt='' />
                            </div>
                            <div className="des">
                                <div>
                                    BLACK CREPE FLORAL PRINT
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-3 item-card">
                        <div className="mt-2">
                            ...
                            <div>
                                <img className="nav-link image" src="./image/Products/14.jpg" alt='' />
                            </div>
                            <div className="des">
                                <div>
                                    BLACK CREPE FLORAL PRINT
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-3 col-sm-3 item-card">
                        <div className="mt-2">
                            ...
                            <div>
                                <img className="nav-link image" src="./image/Products/15.jpg" alt='' />
                            </div>
                            <div className="des">
                                <div>
                                    BLACK CREPE FLORAL PRINT
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-3 item-card">
                        <div className="mt-2">
                            ...
                            <div>
                                <img className="nav-link image" src="./image/Products/16.jpg" alt='' />
                            </div>
                            <div className="des">
                                <div>
                                    BLACK CREPE FLORAL PRINT
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-3 item-card">
                        <div className="mt-2">
                            ...
                            <div>
                                <img className="nav-link image" src="./image/Products/17.jpg" alt='' />
                            </div>
                            <div className="des">
                                <div>
                                    BLACK CREPE FLORAL PRINT
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-3 item-card">
                        <div className="mt-2">
                            ...
                            <div>
                                <img className="nav-link image" src="./image/Products/3.jpg" alt='' />
                            </div>
                            <div className="des">
                                <div>
                                    BLACK CREPE FLORAL PRINT
